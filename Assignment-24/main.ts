...
let transportation1: string = 'AeroPlaNe';
let transportation2: string = 'aeroplane';

if (transportation1.toLowerCase() === transportation2.toLowerCase()) {
    console.log(true) // Output True
} 

else (transportation1.toLowerCase() !== transportation2.toLowerCase()); {
...
let ramzan_dishes: string [] = ["Biryani", "Kung Pao Chicken", "Nihari", "Junk Foods"];
